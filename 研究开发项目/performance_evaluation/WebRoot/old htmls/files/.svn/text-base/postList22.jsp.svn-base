...
function addPost(){
	document.getElementById("fom").action="postAdd";
 ...
 <!-- 这些事表格头上的查找选项
  ...
  <tr>
    <td><table id="subtree1" style="DISPLAY: " width="100%" border="0" cellspacing="0" cellpadding="0">
    	<tr>
        	<td height="20">
		    <a href="post_toAdd.action">添加职位</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    <!--  
		    <input name="Submit" type="button" class="right-button08" value="添加职位" 
		    onclick="window.location='postAdd'" />
		    -->
	    	</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="49%" align="right">[<a href="post_list.action" class="right-font08">首页</a> | <a href="#" class="right-font08">上一页</a> | <a href="#" class="right-font08">下一页</a> | <a href="#" class="right-font08">末页</a>] 转至：</td>
