  ...
  <tr>
    <td><table id="subtree1" style="DISPLAY: " width="100%" border="0" cellspacing="0" cellpadding="0">
    	<tr>
		    ...
		    onclick="window.location='departmentAdd.do'" />
	    	</td>
        </tr>
        <tr>
              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  <tr>
                    ...
                    <td width="8%" height="20" align="center" bgcolor="#EEEEEE">部门编号</td>
                    <td width="10%" align="center" bgcolor="#EEEEEE">部门名称</td>
                    <td width="10%" align="center" bgcolor="#EEEEEE">上级部门</td>
                    <td width="16%" align="center" bgcolor="#EEEEEE">详情</td>
                  </tr>
                   <s:iterator value="departments" var="v_department" status="st">
                   <tr>
				    <td bgcolor="#FFFFFF"><div align="center">${st.index+1}</div></td>
                    <td height="20" bgcolor="#FFFFFF"><div align="center">${v_department.departmentId}</div></td>
                    <td bgcolor="#FFFFFF"><div align="center">${v_department.departmentName}</div></td>
                    <td bgcolor="#FFFFFF"><div align="center">${v_department.higherDepartmentId}</div></td>
