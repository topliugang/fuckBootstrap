						...
						<tr>
							...
							<td width="241"
								...
								<img src="<%=request.getContextPath()%>/jsp/images/311.gif"
									width="16" height="16" />
								<span class="little_title">部门得分查询</span>
							</td>

							<form action="statisticalQuery_departmentScoreQuery" id="departmentForm">
								<td width="120"
									background="<%=request.getContextPath()%>/jsp/images/tab_05.gif">
										...
										<tr>
											...
											<td height="31" bgcolor="#FFFFFF">
												<div align="center" class="STYLE2 STYLE1">
													...
													<textarea rows="2" cols="12%" name="infoList" clas="myDepInfoInput" ><s:property value="instruction"/></textarea-->
													
													<div align="center" class="STYLE2 STYLE1" name="infoList">
														<s:property value="instruction"/>
													</div>
