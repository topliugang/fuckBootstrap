						...
						<tr>
							...
							<td width="241"
								...
								<img src="<%=request.getContextPath()%>/jsp/images/311.gif"
									width="16" height="16" />
								<span class="little_title">周例会记录</span>
							</td>
							...
							<td bgcolor="#f3ffe3">
								<form action="${goBackOrder}" method="post">
									<table width="99%" >
										...
										<tr>
											<td align="right" valign="top" style="font-weight:bold;color:#33CC99;">上传时间：</td>
											<td align="left" valign="top"><input type="text" style="border:1px solid #CCCCCC;width:60%;" value="${monthMeetingRecordToRead.uploadTime}"/></td>
										</tr>
										<tr><td><br/></td><td><br/></td></tr>
										<tr><td><br/></td><td><br/></td></tr>
										<tr><td><br/></td><td><br/></td></tr>
										<tr><td><br/></td><td><br/></td></tr>
										<tr>
											<td align="right" valign="top" style="font-weight:bold;color:#33CC99;">上传人：</td>
											<td align="left" valign="top">
												<input type="text" style="border:1px solid #CCCCCC;width:610px" value="${monthMeetingRecordToRead.uploadStaff.staffName}"/>
											</td>
										</tr>
										...
										<tr>
											<td align="right" valign="top" style="font-weight:bold;color:#33CC99;">会议记录：</td>
											<td align="left" valign="top">	
											<div style="width:720px;heigth:400px;border:1px solid #CCCCCC;">
												${monthMeetingRecordToRead.monthMeetingRecordContent}
											</div>
											</td>
										</tr>
										<tr><td><br/></td><td><br/></td></tr>
