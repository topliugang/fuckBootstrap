						...
						<tr>
							...
							<td width="241"
								...
								<img src="<%=request.getContextPath()%>/jsp/images/311.gif"
									width="16" height="16" />
								<span class="little_title">员工打分查询</span>
							</td>

							<form action="statisticalQuery_staffRecordQuery" id="departmentForm">
								<td width="120"
									background="<%=request.getContextPath()%>/jsp/images/tab_05.gif">
						...
						<tr>
							...
							<td bgcolor="#f3ffe3">
								<table width="99%" border="0" align="center" cellpadding="0"
									...
									<s:iterator value="staffScoreRecords" var="item" status="st">
										<tr>
											<td>
												<div>
											...
											<td>
												<div>
													<s:property value="scoredFromStaff.staffName"></s:property>
												</div>
											</td>
											<td>
												<div>
