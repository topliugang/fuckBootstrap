...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" height="3" style="height: 3px;">
						<tr>
							...
							<td width="241"
								...
								width="16" height="16" />
								<span class="little_title">学习培训材料上传</span>
							</td>
							<td width="999"
								background="<%=request.getContextPath()%>/jsp/images/tab_05.gif">
							</td>
			...
			<tr>
				<td>
					<form  id="myformid" action="trainingPlan_load" enctype="multipart/form-data" method="post">
						<table width="95%"  border="1">

							<tr>
								<th colspan="2">上周工作总结</th>
							</tr>
							<tr>
							    <td width="20%">学习/培训时间</td>
						       	<td width="80%"><textarea name="trainTime"></textarea></td>
							</tr>
							<tr>
							    <td width="20%">学习/培训主题</td>
						       	<td width="80%"><textarea name="trainTopic"></textarea></td>
							</tr>
							<tr>
							    <td width="20%">参会人员姓名</td>
						       	<td width="80%"><textarea name="trainName"></textarea></td>
							</tr>
							<tr height = "480">
							    <td width="20%">培训内容：</td>
						       	<td width="80%">
    								<textarea rows = "40" name="trainContent"></textarea>
    							</td>
							</tr>
