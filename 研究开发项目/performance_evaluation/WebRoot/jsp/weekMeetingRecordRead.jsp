								...
								<form action="${goBackOrder}" method="post">
									<table width="99%" >
										...
										<tr>
											...
											<td align="left" valign="top"><input type="text" style="border:1px solid #CCCCCC;width:60%;" value="${weekMeetingRecordToRead.uploadTime}"/></td>
										</tr>
										<tr><td><br/></td><td><br/></td></tr>
										<tr><td><br/></td><td><br/></td></tr>
										<tr><td><br/></td><td><br/></td></tr>
										...
										<tr>
											...
											<td align="left" valign="top">
												<input type="text" style="border:1px solid #CCCCCC;width:610px" value="${weekMeetingRecordToRead.uploadStaff.staffName}"/>
											</td>
										</tr>
										...
										<tr>
											...
											<div style="width:720px;heigth:400px;border:1px solid #CCCCCC;">
												${weekMeetingRecordToRead.weekMeetingRecordContent}
											</div>
											</td>
										</tr>
										<tr><td><br/></td><td><br/></td></tr>
