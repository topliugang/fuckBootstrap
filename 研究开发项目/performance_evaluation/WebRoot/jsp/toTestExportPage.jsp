...
function checkProgress(){
	document.getElementById('info-td').align='center';
	document.getElementById("info").align='center';
	document.getElementById("info"). innerHTML ='正在检测，请等待... ...';
	window.location.href='statisticalQuery_confirmAccomplishStaffScore';
}
function exportScore(){
	window.location.href='statisticalQuery_exportScoreExcel';
}
</script>
	</head>
						...
						<tr>
							...
							<td width="241"
								...
								<img src="<%=request.getContextPath()%>/jsp/images/311.gif"
									width="16" height="16" />
								<span class="little_title">导出员工绩效</span>
							</td>
			...
			<table id="mainpage_tab">
				<tr>
					...
					<td>
						...
						<div class="f"></div>
						<div id="check" >
						<a href="javascript:checkProgress();" style=" text-decoration none;">检测员工绩效</a></div>
						<!--<div style="width:40px;height:30px;float:left">-->
						<div class="f"></div>
						<div class="f"></div>
						<s:if test="scoreMarker">
							<div id="calculate"><a href="javascript:exportScore();" style=" text-decoration none;">导出员工绩效</a></div>
						</s:if>
						<s:else>
							<div id="calculateNo">导出员工绩效</div>
						</s:else>
					</td>
				</tr>
				...
				<tr>
					...
					<td id="info-td" style="color:#175D87;font-weight:bold;" align="center" valign="top">
						
							<s:if test="scoreMarker">
							<div id="info" align="center">
								<span>员工绩效计算已经完成，可以导出员工绩效了</span>
								</div>
							</s:if>
							 <s:else>
