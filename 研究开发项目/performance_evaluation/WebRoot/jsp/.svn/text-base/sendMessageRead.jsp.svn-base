...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <br/>
	<form action="message_listSent" method="post">
		<table width="99%" >
			<tr>
				<td align="right" valign="top" style="font-weight:bold;color:#33CC99;">接收者：</td>
				...
				--%>
				<s:select theme ="simple" list="messageToRead.receiver" listValue="department.departmentName+staffName" listKey="staffId" id="r_select"></s:select>
				<%--<input type="text" style="border:1px solid #CCCCCC;width:610px" 
			...
			<tr>
				...
				<td align="left" valign="top"><input type="text" style="border:1px solid #CCCCCC;width:610px" value="${messageToRead.messageDate}"/></td>
			</tr>
			<tr><td><br/></td><td><br/></td></tr>
			<tr><td><br/></td><td><br/></td></tr>
			<tr><td><br/></td><td><br/></td></tr>
			...
			<tr>
				...
				<td align="left" valign="top">	
					<textarea rows="10" cols="74" style="border:1px solid #CCCCCC;" >${messageToRead.content}</textarea>
				</td>
			</tr>
			<tr><td><br/></td><td><br/></td></tr>
			<tr>
