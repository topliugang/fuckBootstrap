						...
						<tr>
							...
							<td width="241"
								...
								<img src="<%=request.getContextPath()%>/jsp/images/311.gif"
									width="16" height="16" />
								<span class="little_title">添加部门信息</span>
							</td>
						...
						<tr>
							...
							<td bgcolor="#f3ffe3">
								...
								<tr>
									...
									<td>
										<input style="border:1px solid #CCCCCC;" name='departmentWillAdd.departmentName' type="text" />
									</td>
								</tr>
								<tr><td><br/></td></tr>
								<tr>
									...
									<td>
										<s:select theme ="simple" list="departmentsToList" listValue="departmentName"
											listKey="departmentId" name="departmentWillAdd.higherDepartmentId">
										</s:select>
									</td>
								</tr>
								<tr><td><br/></td></tr>
