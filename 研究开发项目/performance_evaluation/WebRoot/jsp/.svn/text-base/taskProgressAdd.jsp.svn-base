						...
						<tr>
							...
							<td width="241"
								...
								<img src="<%=request.getContextPath()%>/jsp/images/311.gif"
									width="16" height="16" />
								<span class="little_title">任务进度录入</span>
							</td>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#f3ffe3">
								<!-- here-->
								<form action="taskProgress_input" method="post">
									<table width="100%">
										<tr>
											<td>任务进度</td>
										...
										<tr>
											<td>年份</td>
											<td><input name="whichyear" type="text"></td>
										</tr>
										<tr>
											<td>年份</td>
											<td><input name="whichmonth" type="text"></td>
										</tr>
										<tr>
