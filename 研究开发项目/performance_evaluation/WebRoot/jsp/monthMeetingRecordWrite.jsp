...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" height="3" style="height: 3px;">
						<tr>
							...
							<td width="241"
								...
								width="16" height="16" />
								<span class="little_title">月例会上传</span>
							</td>
							<td width="999"
								background="<%=request.getContextPath()%>/jsp/images/tab_05.gif">
							</td>
			...
			<tr>
				<td>
					<form  id="myformid" action="monthMeeting_load" enctype="multipart/form-data" method="post">
						<table width="100%"  border="1">
						  ...
						  <tr height="48">
						    <td><textarea name="lastNeirong"></textarea></td>
						    <td><textarea  name="lastBuzhou"></textarea></td>
						    <td><textarea  name="lastWancheng"></textarea></td>
						    <td><textarea  name="lastYuanyin"></textarea></td>
						  </tr>
						  <tr height="48">
						    <td><textarea name="lastNeirong"></textarea></td>
						    <td><textarea  name="lastBuzhou"></textarea></td>
						  ...
						  <tr>
						   ...
						   <tr height="48">
						    <td><textarea  name="thisNeirong"></textarea></td>
						    <td><textarea  name="thisBuzhou"></textarea></td>
						    <td colspan="4"><textarea  name="thisWancheng"></textarea></td>
						  </tr>
						   <tr height="48">
						    <td><textarea  name="thisNeirong"></textarea></td>
						    <td><textarea  name="thisBuzhou"></textarea></td>
