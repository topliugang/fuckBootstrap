...
public class DepartmentKeyWorkDao {
	 ...
	 * @throws Exception
	 */
	public List<DepartmentKeyWork> getMyDepartmentKeyWorkList()throws Exception{
		...
		String sql="select dwk.key_work_id,dwk.department_id,d.department_name,d.higher_department_id," +
				...
				"from department_key_work dwk,department d where dwk.department_id=d.department_id ";
	...
	//-----------------------------------------------------------------------------------分页代码开始
	public List<DepartmentKeyWork> getMyDepartmentKeyWorkList(int pageStart,int pageSize)throws Exception{
		List<DepartmentKeyWork> departmentKeyWorks=new ArrayList<DepartmentKeyWork>();
		String sql="select dwk.key_work_id,dwk.department_id,d.department_name,d.higher_department_id," +
		"dwk.key_work_content,dwk.start_year,dwk.start_month,dwk.end_year,dwk.end_month " +
		"from department_key_work dwk,department d where dwk.department_id=d.department_id limit ?,?";
	...
	public int getTotalRecored()throws Exception{
		int count=0;
		String sql="select count(*) count from department_key_work dwk,department d where dwk.department_id=d.department_id ";
